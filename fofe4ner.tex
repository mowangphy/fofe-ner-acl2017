...
%or similarly the segment ``'Li, director of'.
...
\begin{table*}
	\resizebox{\linewidth}{!}{
		...
		\begin{tabular}{|l|lll|lll|lll|lll|}
			...
			\hline 
	\end{tabular}}
	\caption{Official entity discovery performance of our methods on KBP2016 trilingual EDL track.\footnote{Neither KBP2015 nor in-house data labels nominals.}}
	\label{tbl:kbp2016}
\end{table*}
...
%After we fix a preprocessing bug, the same setting yields 0.750 in the evaluation round II. 
